...
veeamInfluxDBURL="https://10.12.0.156/" ##Use https://fqdn or https://IP in case you use SSL
veeamInfluxDBPort="8086" #Default Port
veeamInfluxDB="veeam" #Default Database
veeamInfluxDBUser="admin" #User for Database
veeamInfluxDBPassword="rbrgVvhTjt4dsA97" #Password for Database

# Endpoint URL for login action
veeamUsername="PARCORRETORA\sis.veeam" #Usually domain\user or user@domain.tld
